...
public class story_script_w01e07 : MonoBehaviour
{
    ...
    Vector2[] endpos = new Vector2[] {new Vector2(-6.7f, 4.57f), new Vector2(6.7f, 4.57f), new Vector2(0, -4.57f)};
    float progress = 0f;
    ...
    void Start()
    {
        ...
        if (!StoryDone)
        {
            asyncOperation = SceneManager.LoadSceneAsync("W01L08");
            _Level.actualLevel = 7;
        }
        else
        {
