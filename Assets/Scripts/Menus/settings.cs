...
public class settings : MonoBehaviour
{
    ...
    public void Awake()
    {
       // gameObject.GetComponentInChildren<Animator>().Play("boxAnim");
    ...
    public void Mail()
    {
        ...
        {
            Application.OpenURL("mailto:kontakt@danielszulc.pl?subject=Kevin's Adventures");
        }
        else if (LevelManager.lang == LevelManager.Language.de)
        {
            Application.OpenURL("mailto:kontakt@danielszulc.pl?subject=Kevins Abenteuer");
        }
        else if (LevelManager.lang == LevelManager.Language.pl)
        {
            Application.OpenURL("mailto:kontakt@danielszulc.pl?subject=Przygody Kevina");
        }
        }
    ...
    public void PrivacyPolicy()
    {
        if (LevelManager.lang == LevelManager.Language.en)
        {
            Application.OpenURL("https://www.danielszulc.pl/kevinsadventures/privacy-policy/");
        }
        else if (LevelManager.lang == LevelManager.Language.pl)
        {
            Application.OpenURL("https://www.danielszulc.pl/pl/kevinsadventures/privacy-policy/");
        }
        else if (LevelManager.lang == LevelManager.Language.de)
        {
            Application.OpenURL("https://www.danielszulc.pl/de/kevinsadventures/privacy-policy/");
        }
    }
